...
import com.example.inventarymanagement.security.DatabaseUserDetailsService;
import com.example.inventarymanagement.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/v3/api-docs/**","/favicon.ico", "/swagger-ui/**", "/swagger-ui.html", "/actuator/health").permitAll()
