...
public class ProductCreateRequest {
    ...
    @Min(0)
    @JsonAlias({ "initial_quantity_on_hand", "initialQuantity", "openingQuantity" })
    private Integer initialQuantityOnHand = 0;
    ...
    public void setInitialQuantityOnHand(Integer initialQuantityOnHand) {
